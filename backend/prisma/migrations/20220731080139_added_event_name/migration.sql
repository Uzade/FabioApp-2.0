...
CREATE TABLE "new_Permition" (
    ...
    "name" TEXT NOT NULL DEFAULT 'unnamed-permition',
...
INSERT INTO "new_Permition" ("id", "manageDevices", "manageEvents", "manageOffers", "name", "requestOffers", "scanDevices", "seeOwnOffers") SELECT "id", "manageDevices", "manageEvents", "manageOffers", "name", "requestOffers", "scanDevices", "seeOwnOffers" FROM "Permition";
